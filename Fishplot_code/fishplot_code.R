...
outdir <- file.path(root_dir, paste0("fishplots_png_", data_filename))
cache_file <- file.path(root_dir, paste0("fishplot_cache_", data_filename, ".RData"))
